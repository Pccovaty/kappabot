...
bot.on("message", async message => {
  ...
  if(cmd === `${prefix}prefixset`){
     message.react("452183703267835910");
  if (!message.member.hasPermission("MANAGE_SERVER")) return message.reply(":lock: Dostęp zablokowany. Nie posiadasz roli Moderator lub wyższej");
